...
class Ui_MainWindow(QWidget):
    def setupUi(self, MainWindow):
        ...
        #self.mapper.setHtml(data.getvalue().decode())
        self.gridLayout_2.addWidget(self.widget, 3, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "CommStatX BETA 0.06"))
    ...
    def databasesize(self):
        ...
        if rundirect > 0:
            print("executing directed process for new statrep ")
            self.directed()
        ...
        if rundirect > 0:
            print("executing directed process for new bulletin ")
            self.directed()
        ...
        if rundirect > 0:
            print("executing directed process for marquee change")
            self.directed()
        ...
        #print(str(marqueerwcnt)+" "+str(newmarqueerows))
        if rundirect > 0:
            print("executing directed process for heard list change")
            self.directed()
